...
Rectangle {
    ...
    property real particleRadius: (Screen.width * 0.002)
   ...
   DebugDraw {
    ...
    Component.onCompleted: {
        // createParticleRectangle ((waveBox.wallThickness), (waveBox.wallThickness), (waveBox.width - (2 * waveBox.wallThickness)), (waveBox.height / 3), (particleRadius*2), particleVectorArray);
        createParticleRectangle ((waveBox.x + waveBox.wallThickness), (waveBox.y + waveBox.wallThickness), (waveBox.width - (2 * waveBox.wallThickness)), (waveBox.height / 1.5), (particleRadius*2));
    }
}
